        ...
        <div className="container">
          <div className="line-contacts__wrapper">
            <div className="line-contacts__wrap">
              <img className="sm-icon" src={imgd207b8fbfd66032909fbe79073f45685} alt="icon" />
              <span className="sm-text">Горячая линия «Мособлэнерго» По вопросам аварийных отключений и качеству электроэнергии </span>
              <a className="tel" href="tel:+74959950099" title="Горячая линия «Мособлэнерго» По вопросам аварийных отключений и качеству электроэнергии">
                +7 (495) 99-500-99
              </a>
            </div>
            <div className="line-contacts__wrap">
              <img className="sm-icon" src={imgd207b8fbfd66032909fbe79073f45685} alt="icon" />
              <span className="sm-text">Технологическое присоединение Консультации по вопросам присоединения к электросети </span>
              <a className="tel" href="tel:+74957850000" title="Технологическое присоединение Консультации по вопросам присоединения к электросети">
                +7 (495) 785-00-00
              </a>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="page-footer__down">
            <div className="page-footer__flex">
              <div className="footer-link-kompany" id="i-13-i-12-bitrix-menu-footer-link-kompany-mKUqxKGMvHpP">
                <img className="footer-link-kompany__logo" src={gerb} alt="Герб" />
                <a className="footer-link-kompany__link" href="https://mosreg.ru/" target="_blank" rel="noreferrer">
                  <span>Правительство московской области</span>
                </a>
                <a className="footer-link-kompany__link" href="https://minenergo.mosreg.ru/" target="_blank" rel="noreferrer">
                  <span>Министерство энергетики Московской области</span>
                </a>
              </div>
              <div className="social" id="i-25-i-24-bitrix-news-list-social-ZF1lvfcvg99a">
              ...
              <div className="footer-wrap-link" id="i-15-i-14-bitrix-menu-footer-wrap-link-QCJ7JgRxyjuV">
                ...
                <a className="footer-wrap-link__row" href="http://www.consultant.ru/cons/cgi/online.cgi?from=221444-0&amp;rnd=B368155CDEE9313B15DF85BD2F39D334&amp;req=doc&amp;base=LAW&amp;n=372838&amp;REFDOC=221444&amp;REFBASE=LAW#a9yu0niwfqw">
                  ...
                  <span className="footer-wrap-link__text">Политика конфиденциальности</span>
                </a>
              </div>
              <div className="page-footer__block-text">
                <span className="page-footer__text">
                  Copyright © {new Date().getFullYear()} <b>АО «Мособлэнерго».</b>{" "}
                </span>
