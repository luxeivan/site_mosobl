    ...
    <div className="page-grid__content" id="content">
      ...
      <div className="block-info">
        ...
        <div className="block-info__down">
          <div className="text-block">
            Подать заявку на технологическое присоединение к электрическим сетям АО "Мособлэнерго" Вы можете в личном кабинете на{" "}
            <a href="https://moetp.ru" target="_blank">
              "Портале потребителя"
            </a>
            .
          </div>
      ...
      <div className="block-info">
        ...
        <div className="block-info__down">
          <div className="text-block">
            <p>
              Также заявку можно оформить на Портале Государственных и муниципальных услуг Московской области -{" "}
              <a href="https://uslugi.mosreg.ru/" target="_blank">
