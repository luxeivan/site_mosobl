          ...
          <div className="accordion-row">
            ...
            <div className="accordion-row__drop-down">
              <div className="accordion-row__wrapper">
                ...
                <p></p>
                <p>
                  <strong>Техническое и&nbsp;оперативное обслуживание электрических сетей</strong>&nbsp;— это мероприятия, проводимые специально обученным электротехническим персоналом с&nbsp;целью обеспечения бесперебойной работы
                  электрооборудования.
                </p>
                <p>Неисправность электроустановки ведет к&nbsp;простоям офисов, складов, торговых залов, цехов и&nbsp;заводов, что приводит к&nbsp;финансовым потерям, срывам сроков поставок и&nbsp;многим другим проблемам.</p>
                <p>
                  По статистике главной причиной возникновения пожаров на&nbsp;объектах считается замыкание в&nbsp;электропроводке. Большинство из&nbsp;них можно было&nbsp;бы избежать, если&nbsp;бы в&nbsp;электроустановке проводилось периодическое
                  техническое обслуживание, за&nbsp;время проведения которого возникшие неисправности можно было обнаружить и&nbsp;устранить на&nbsp;этапе их&nbsp;возникновения, а&nbsp;не&nbsp;после аварийного отключения электроустановки,
                  а&nbsp;в&nbsp;худшем случае&nbsp;— при возникновении пожара.
                </p>
                <p>
                  Данные работы имеют право выполнять только компании, получившие соответствующие разрешения от&nbsp;надзорных органов, и&nbsp;их&nbsp;работники, подтвердившие свою квалификацию. Объемы задач и&nbsp;требуемые навыки к&nbsp;персоналу
                  во&nbsp;время работ достаточно высоки, поэтому к&nbsp;обслуживанию электрооборудования допускают только высококвалифицированных инженеров и&nbsp;электромонтеров.
                </p>
                <p>АО «Мособлэнерго» предоставляет услугу по&nbsp;обслуживанию оборудования силами своего персонала.</p>
                <p>Наши специалисты произведут осмотр оборудования, осуществят контроль его работы и&nbsp;все необходимые оперативные переключения. При необходимости составят техническое задание на&nbsp;ремонт.</p>
                <p>
                  <strong>Обслуживание электрических сетей нашим персоналом позволит Вам:</strong>
                </p>
                <ul>
                  <li>
                    <p>отказаться от содержания собственного электротехнического персонала;</p>
                  </li>
                  <li>
                    <p>обеспечить надежное и&nbsp;непрерывное энергоснабжение;</p>
                  </li>
                  <li>
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Оперативное обслуживание ТП, РП, КТП 10-6/0,4 кВ</td>
                        <td>объект</td>
                        <td>индивидуально</td>
                      </tr>
                      <tr>
                        ...
                        <td>Оперативное обслуживание КРН, ЛР и др. отдельного оборудования</td>
                        <td>объект</td>
                        <td>индивидуально</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>Отключение/ включение ячейки с ВН или разъединителем</td>
                        <td>объект</td>
                        <td>4 200,00</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          по договорам с АО «Мособлэнерго» <br />и договорам технологического присоединения)
                        </td>
                        <td>1 выезд</td>
                        <td>9 950,00</td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          &nbsp;трансформаторной подстанции
                          <br />
                          &nbsp;заявителя (ЗТП, 2БКТП), <br />с выдачей заключения
                        </td>
                        <td>объект</td>
                        <td>16&nbsp;020,00</td>
                      </tr>
          ...
          <div className="accordion-row">
            ...
            <div className="accordion-row__drop-down">
              <div className="accordion-row__wrapper">
                ...
                <p>
                  Особенность ремонта устройств электрических сетей заключается в том, что все работы производятся непосредственно на месте повреждения. Это обстоятельство требует большой ответственности, грамотной организации и подготовки рабочего
                  места с доставкой к месту работ инструмента, механизмов, приспособлений и материалов, необходимых для ремонта, выполнения ограждения рабочего места и обеспечения безопасности труда ремонтного персонала.
                </p>
                <p>АО «Мособлэнерго» предоставляет услуги по ремонту линий электропередач, трансформаторных подстанций и других электрических сетей. Возможность проведения текущих ремонтов, плановых и срочных ремонтно-восстановительных работ.</p>
                <p>
                  Наша компания обладает всеми необходимыми средствами для качественного производства работ. В нашем распоряжении большой автопарк специализированной техники, большое количество запасов материала и запасных частей для разнообразного
                  электрооборудования.
                </p>
                <p>
                  Благодаря высокой квалификации наших работников, наличию современной техники, большому количеству производственных отделений, а также строгому соблюдению технических норм, все работы выполняются максимально качественно и в короткие
                  сроки.
                </p>
                <p>За более чем 15 — летний опыт работы на благо Московской области, тысячи компании доверили свои электрические сети в наши руки.</p>
                <p>
                  <strong>Услуга по ремонту электрических сетей включают в себя:</strong>
                </p>
                <ul>
                  <li>
                  ...
                  <li>
                    <p>выявление неисправностей в работе электрооборудования;</p>
                  </li>
                  <li>
                    <p>составление и согласование с заказчиком дефектной ведомости объемов работ;</p>
                  </li>
                  <li>
                    <p>проведение ремонтных работ;</p>
                  </li>
                  <li>
                    <p>оформление приемо-сдаточной документации по завершении работ.</p>
                  </li>
                </ul>
                <div className="wrap-table">
                  <table>
          ...
          <div className="accordion-row">
            ...
            <div className="accordion-row__drop-down">
              <div className="accordion-row__wrapper">
                ...
                <p>
                  <strong>
                    Персоналу любой организации допускается пользоваться средствами электрозащиты только в рабочем состоянии. Будьте всегда уверены в безопасности своего персонала и их снаряжения. Помните, что исправные средства защиты снижают риск
                    вероятности аварийной ситуации на Вашем объекте!
                  </strong>
                </p>
                <p>
                  <strong>
                    Испытания и диагностика средств индивидуальной защиты являются обязательным условием для проверки их пригодности к использованию, способствуют выявлению неисправностей и предотвращению несчастных случаев при проведении работ.
                  </strong>
                </p>
                <p>
                  АО «Мособлэнерго» предлагает услуги собственной электролаборатории, которая выполняет испытание средств индивидуальной защиты и электроинструмента на специальном оборудовании с предоставлением официального документа по результатам
                  испытаний.
                </p>
                <p>
                  Испытание средств индивидуальной защиты в лабораторных условиях предполагает, что они поддаются влиянию определенного напряжения, которое обычно присутствует при работе с электроустановками и оборудованием. Предварительно
                  специалисты проводят осмотр изделий, проверяют их маркировку, компактность, целостность и общее состояние. Особое внимание уделяется изоляционному покрытию, которое и обеспечивает высокий уровень защиты сотрудника во время работы.
                </p>
                <p>
                  Испытания проводятся высококвалифицированным персоналом с соблюдением всех норм в соответствии с Инструкцией по применению и испытанию средств защиты, используемых в электроустановках СО 153-34.03.603-2003,утвержденной приказом
                  Минэнерго России от 30 июня 2003 г. N 261.
                </p>
                <p>По окончанию испытаний на изделие ставится соответствующий штамп, и составляется протокол испытаний, который выдается клиенту.</p>
                <div className="wrap-table">
                  <table>
                    <colgroup>
                      <col /> <col /> <col /> <col />
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Испытание: Указатели высокого напряжения до 35 кВ</td>
                        <td>шт.</td>
                        <td>880,00</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>Определение электрической прочности трансформаторного масла (Без выезда)</td>
                        <td>проба</td>
                        <td>2 500,00</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          Испытание масляного/вакуумного выключателя <nobr>6-10 кВ</nobr>
                        </td>
                        <td>шт.</td>
                        <td>9 450,00</td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          Измерение временных/скоростных характеристик выключателя <nobr>6-10 кВ</nobr>
                        </td>
                        <td>шт.</td>
                        <td>5 750,00</td>
                      </tr>
          ...
          <div className="accordion-row">
            ...
            <div className="accordion-row__drop-down">
              <div className="accordion-row__wrapper">
                ...
                <ul>
                  <li>
                    <a href={`${addressServer}/uploads/p_4_forma_zayavki_dlya_yur_licz_abc014898e.doc?updated_at=2022-11-15T07:45:39.087Z`}>Форма заявки для юридических лиц</a>
                  </li>
                  <li>
                    <a href={`${addressServer}/uploads/p_4_forma_zayavki_dlya_ind_pred_cb277dc036.doc?updated_at=2022-11-15T07:45:39.458Z`}>Форма заявки для индивидуальных предпринимателей</a>
                  </li>
                  <li>
                    <a href={`${addressServer}/uploads/p_4_forma_zayavki_dlya_fiz_licz_d88aad773c.doc?updated_at=2022-11-15T07:45:39.295Z`}>Форма заявки для физических лиц</a>
                  </li>
                </ul>
                <p></p>
                <p> АО «Мособлэнерго» предоставляет услуги по проектированию и строительству электрических сетей любой сложности.</p>
                <p>
                  {" "}
                  <strong>За 15 лет работы наша компания приобрела огромный опыт в проектировании любых электросетевых объектов:</strong>
                </p>
                <ul>
                  <li>
                    <p> проектирование и строительство трансформаторных подстанций (ТП), кабельных и воздушных линий электропередачи;</p>
                  </li>
                  <li>
                    <p> сборка и монтаж щитов учёта на опорах для возможности присоединения электрооборудования и электроинструмента на период строительства;</p>
                  </li>
                  <li>
                    <p> технологическое присоединение энергопринимающих устройств (временных и постоянных строений) на территории земельного участка;</p>
                  </li>
                  <li>
                    <p> монтаж вводов и многое другое.</p>
                  </li>
                </ul>
                <p> Все проводимые проектные и строительные работы ведутся с учетом необходимого уровня надежности электроснабжения потребителей, нормирования качества электроэнергии, возможного роста электрических нагрузок.</p>
                <p>
                  {" "}
                  АО «Мособлэнерго» имеет все необходимые лицензии для данного вида деятельности, имеет аттестацию в комиссии Ростехнадзора и привлекает к выполнению работ высококвалифицированных специалистов. Благодаря опыту компании и её
                  клиентоориентированности всем проектам, независимо от их объема, уделяется одинаково пристальное внимание, поэтому работы выполняются качественно и в максимально короткие сроки. По окончании работ АО «Мособлэнерго» может подготовить
                  для Вас полный пакет документов для представления в Ростехнадзор и заключения договора электроснабжения.
                </p>
                ...
                <table align="center">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>Замена трансформатора тока в электроустановках до 1000 В</td>
                      <td style={{ textAlign: "center" }}>1 шт.</td>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>Замена испытательной коробки в электроустановках до 1000 В</td>
                      <td style={{ textAlign: "center" }}>1 шт.</td>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>
                        Замена электросчетчика <nobr>1-фазного</nobr> в электроустановках до 1000 В
                      </td>
                      <td style={{ textAlign: "center" }}>1 шт.</td>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>Свыше 400 А до 1000 А</td>
                      <td style={{ textAlign: "center" }}>1 шт.</td>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>Свыше 1000 А (согласно сметного расчёта)</td>
                      <td style={{ textAlign: "center" }}>1 шт.</td>
                      <td style={{ textAlign: "center" }}>индивидуально</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>Для физических лиц (до 1000 В) (с выездом)</td>
                      <td style={{ textAlign: "center" }}>1 точка присоединения</td>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>Для юридических лиц (до 1000 В) (с выездом)</td>
                      <td style={{ textAlign: "center" }}>1 точка присоединения</td>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>
                        Установка трансформатора тока в электроустановках <nobr>6-10 кВ</nobr>
                      </td>
                      <td style={{ textAlign: "center" }}>1 шт.</td>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>
                        Установка трансформатора напряжения <nobr>1-фазного</nobr> в электроустановках <nobr>6-10 кВ</nobr>
                      </td>
                      <td style={{ textAlign: "center" }}>1 шт.</td>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>
                        Установка трансформатора напряжения <nobr>3-фазного</nobr> в электроустановках <nobr>6-10 кВ</nobr>
                      </td>
                      <td style={{ textAlign: "center" }}>1 шт.</td>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>Установка испытательной коробки в электроустановках свыше 1000 В</td>
                      <td style={{ textAlign: "center" }}>1 шт.</td>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>
                        Установка электросчетчика <nobr>3-фазного</nobr> трансформаторного включения в электроустановках свыше 1000 В
                      </td>
                      <td style={{ textAlign: "center" }}>1 шт.</td>
                      <td style={{ textAlign: "center" }}>от 5 000</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>Замена шкафа учета в электроустановках свыше 1000 В</td>
                      <td style={{ textAlign: "center" }}>1 шт.</td>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>
                        Замена трансформатора тока в электроустановках <nobr>6-10 кВ</nobr>
                      </td>
                      <td style={{ textAlign: "center" }}>1 шт.</td>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>
                        Замена трансформатора напряжения <nobr>1-фазного</nobr> в электроустановках <nobr>6-10 кВ</nobr>
                      </td>
                      <td style={{ textAlign: "center" }}>1 шт.</td>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>
                        Замена трансформатора напряжения <nobr>3-фазного</nobr> в электроустановках <nobr>6-10 кВ</nobr>
                      </td>
                      <td style={{ textAlign: "center" }}>1 шт.</td>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>
                        Замена электросчетчика <nobr>3-фазного</nobr> трансформаторного включения в электроустановках свыше 1000 В
                      </td>
                      <td style={{ textAlign: "center" }}>1 шт.</td>
                      <td style={{ textAlign: "center" }}>от 8 000</td>
                    </tr>
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>Замена испытательной коробки в электроустановках свыше 1000 В</td>
                      <td style={{ textAlign: "center" }}>1 шт.</td>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>Затягивание кабеля (провода) в трубы ПВХ диаметром до 50 мм</td>
                      <td style={{ textAlign: "center" }}>1 м.</td>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>Прокладка кабеля навесным монтажом по стенам готовых строений</td>
                      <td style={{ textAlign: "center" }}>1 м.</td>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>Прокладка кабеля в стенах готовых строений</td>
                      <td style={{ textAlign: "center" }}>1 м.</td>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>Прокладка интерфейсного кабеля</td>
                      <td style={{ textAlign: "center" }}>1 м.</td>
                      <td style={{ textAlign: "center" }}>от 270</td>
                    </tr>
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>Демонтаж короба с интерфейсным кабелем</td>
                      <td style={{ textAlign: "center" }}>1 м.</td>
                      <td style={{ textAlign: "center" }}>от 270</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>Замена кабеля в стенах готовых строений</td>
                      <td style={{ textAlign: "center" }}>1 м.</td>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "center" }}>Прочие строительно-монтажные работы</td>
            ...
            <div className="accordion-row__drop-down">
              <div className="accordion-row__wrapper">
                ...
                <p>
                  ...
                  имиджа и авторитета наших клиентов.
                </p>
                <p>
                  {" "}
                  <strong>Компания располагает помещениями и объектами различного назначения, поэтому любой клиент сможет найти для себя интересующий вариант:</strong>
                </p>
                <ul>
                  <li>
                    <p> объекты общего пользования позволят Вам использовать помещение в качестве офиса, складских помещений и для других целей;</p>
                  </li>
                  <li>
                    <p> площади на крышах зданий и на земельных участках позволяют клиенту разместить радиобашни, радиомачты и другое коммуникационное оборудование;</p>
                  </li>
                  <li>
                    <p> места для размещения рекламных баннеров — возможность разместить свою рекламу на здании, земельном участке и другом недвижимом имуществе;</p>
                  </li>
                  <li>
                ...
                <p>
                  {" "}
                  <strong>Большой список предоставляемой площади позволит выбрать наиболее подходящий вариант для Вашего бизнеса. Использование площадей, предоставляемых нашей компанией, имеет неоспоримые преимущества:</strong>
                </p>
                <ul>
                  <li>
                  ...
                  <table>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          Предоставление доступа <br />к инфраструктуре для установки <br />
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <br />
                          сторонним лицам (пользователям) <br />к воздушным линиям 0,4 кВ <br />
                      ...
                      <tr>
                        ...
                        <td>
                          Тариф за предоставление доступа
                          <br />
                          сторонним лицам (пользователям) <br />к воздушным линиям 6/10 кВ <br />
                          для размещения оборудования
                        </td>
                        <td>1 место подвеса на опоре</td>
                        <td>99,29</td>
          ...
          <div className="accordion-row">
            ...
            <div className="accordion-row__drop-down">
              <div className="accordion-row__wrapper">
                ...
                <p>
                  <b>Знания и опыт АО «Мособлэнерго», осведомленность об изменениях в нормативно-правовой базе в электроэнергетике позволяет обеспечить высокое качество оказываемых предоставляемых услуг.</b>
                </p>
                <div className="wrap-table">
                  <table align="center">
                    <colgroup>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>
                          ...
                          для подготовки проектов строительства <br />и проектов производства работ (ППР)
                        </td>
                        <td style={{ textAlign: "center" }}>1 объект</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>
                          Консультация по техническим вопросам <br />с выездом на объект
                        </td>
                        <td style={{ textAlign: "center" }}>шт.</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>
                          Допуск бригад сторонних организаций <br />к работам в охранной зоне <br />
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Расчет пропускной способности ЛЭП</td>
                        <td style={{ textAlign: "center" }}>шт.</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>*20 000,00 за не точечный объект</td>
                      </tr>
                      <tr>
                        <td style={{ textAlign: "center" }}>4 000,00 **за точечный объект</td>
                      </tr>
                      <tr>
                        <td style={{ textAlign: "center" }}>
                          {" "}
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Оформление акта согласования технологической и(или) аварийной брони электроснабжения потребителя электрической энергии (мощности)</td>
                        <td style={{ textAlign: "center" }}>1 объект</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>
                          Подготовка и направление <br />в адрес органа федерального <br />
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>
                          Уменьшение сроков подготовки документации до 3 рабочих дней (за исключением п.06-12, <nobr>06-13,</nobr> <nobr>06-15)</nobr>
                        </td>
                        <td style={{ textAlign: "center" }}>1 шт.</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Восстановление и переоформление документов о технологическом присоединении</td>
                        <td style={{ textAlign: "center" }}>1 объект</td>
                      ...
                      <tr>
                        ...
                        <td rowSpan="5" style={{ textAlign: "center" }}>
                        Подготовка комплекта документов, подтверждающих технологическое присоединение к электросетевым объектам сторонних лиц (акт разграничения балансовой принадлежности электросетей, акт допуска в эксплуатацию прибора учета электрической энергии)
                        </td>
                        <td rowSpan="5" style={{ textAlign: "center" }}>
                          Комплект документов
                        </td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Согласование и выверка схемы актов границ опосредованного присоединения</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Подготовка предварительных технических условий на технологическое присоединение</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>
                          Повторное рассмотрение документации по услуге 06-11 при условии устранения замечаний в срок, не превышающий 90 дней*
                          <br />
                          &nbsp;
                          <i>
                            * Конечным результатом рассмотрения документации является ее согласование при условии отсутствия обоснованных замечаний или выставление обоснованных замечаний при их наличии.
                            <br />
                          </i>
                          <i>
                            Замечания по результатам рассмотрения документации выдаются единовременно. При повторном рассмотрении документации производится проверка устранения ранее выданных замечаний и проверка на возможное возникновение новых
                            замечаний вследствие корректировки проектной документации заказчиком
                            <br />
                          </i>
                          <i>В случае предоставления документации на повторное рассмотрение в срок, превышающий 90 дней, взимается полная стоимость услуги.</i>
                        </td>
                        <td style={{ textAlign: "center" }}>за каждый том (согласование)</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Прочие консультационные услуги</td>
                        <td style={{ textAlign: "center" }}>1 объект</td>
                        <td style={{ textAlign: "center" }}>индивидуально</td>
                      </tr>
                    </tbody>
            ...
            <div className="accordion-row__drop-down">
              <div className="accordion-row__wrapper">
                ...
                <p>
                  ...
                  или ремонтных работ, избавляя клиентов от необходимости покупки, ремонта и обслуживания собственного транспорта.
                </p>
                <p>
                  {" "}
                  <strong>
                    АО «Мособлэнерго» оказывает транспортные услуги в Московской области и предлагает при проведении строительно-монтажных работ воспользоваться своими средствами механизации. Парк техники компании представлен более 1500 единицами
                    наиболее востребованных образцов машин и механизмов различной грузоподъемности и функциональности:
                  </strong>
                </p>
                <ul>
                  <li>
                    <p> спецтехника для выполнения различных строительных и ремонтных работ;</p>
                  </li>
                  <li>
                ...
                <p> Все автомобили, в том числе и специализированные, своевременно проходят ТО и управляются квалифицированным персоналом.</p>
                <p> Также АО «Мособлэнерго» предлагает услуги по предоставлению в аренду автономных источников электроснабжения (передвижных электростанций) мощностью до 650 кВа, с предоставлением дежурного персонала (за дополнительную плату).</p>
                <p>
                  {" "}
                  Нередко потребитель, впервые столкнувшись с проблемой отключения электроэнергии на короткий или длительный срок, может принять поспешное решение о приобретении дизельного генератора. Это не всегда оправдано, так как покупка такого
                  дорогого оборудования, как правило, не окупается, а использование услуги аренды генератора будет верным и гораздо более экономичным решением. Если Вы сомневаетесь в мощности генератора, который необходим, Вам помогут наши
                  специалисты.
                </p>
                <div className="wrap-table">
                  <table align="center">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Услуги передвижной электротехнической лаборатории на базе автомобиля с персоналом</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Автокран, до 6 т</td>
                        <td style={{ textAlign: "center" }}>час</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Автокран, от 6 до 16 т</td>
                        <td style={{ textAlign: "center" }}>час</td>
                        <td style={{ textAlign: "center" }}>2 900,00</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Автомобили бортовые, грузоподъемность до 5 т</td>
                        <td style={{ textAlign: "center" }}>час</td>
                        <td style={{ textAlign: "center" }}>3 200,00</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Бригада для работы на автоподъёмнике</td>
                        <td style={{ textAlign: "center" }}>час</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Автомобиль бортовой с краном-манипулятором</td>
                        <td style={{ textAlign: "center" }}>час</td>
                        <td style={{ textAlign: "center" }}>3 000,00</td>
                      </tr>
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Автоподъемник (длина стрелы 18 м)</td>
                        <td style={{ textAlign: "center" }}>час</td>
                        <td style={{ textAlign: "center" }}>1 800,00</td>
                      </tr>
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Автоподъемник (длина стрелы 22 м)</td>
                        <td style={{ textAlign: "center" }}>час</td>
                        <td style={{ textAlign: "center" }}>2 600,00</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Работы ответственного за безопасное производство с грузоподъемным механизмом</td>
                        <td style={{ textAlign: "center" }}>час</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Работы по строповке и увязке грузов</td>
                        <td style={{ textAlign: "center" }}>час</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Экскаватор 0,8 м.куб</td>
                        <td style={{ textAlign: "center" }}>час</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Экскаватор-погрузчик 0,25 м.куб</td>
                        <td style={{ textAlign: "center" }}>час</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Экскаватор с ковшом-дробилкой</td>
                        <td style={{ textAlign: "center" }}>час</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Автомобиль грузовой, длинномер</td>
                        <td style={{ textAlign: "center" }}>час</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>От 400 кВт до 1000 кВт</td>
                        <td style={{ textAlign: "center" }}>час</td>
            ...
            <div className="accordion-row__drop-down">
              <div className="accordion-row__wrapper">
                ...
                <p>
                  ...
                  энергоресурсов. Реализовать меры эффективного энергосбережения невозможно, если на предприятии не обеспечивается точный учет потребления электроэнергии. Важнейшим шагом на этом пути станет создание АИИСКУЭ.
                </p>
                <p>
                  {" "}
                  <strong>АИИСКУЭ</strong> — автоматизированная информационно-измерительная система коммерческого учёта электроэнергии, которая обеспечивает дистанционный сбор информации с интеллектуальных приборов учета, передачу этой информации на
                  верхний уровень с последующей ее обработкой. Создание АИИСКУЭ позволяет автоматизировать учет и добиться его максимальной точности.{" "}
                </p>
                <p>
                  {" "}
                  <strong>Автоматизированные информационно-измерительные системы коммерческого учёта электроэнергии выполняют ряд основных функций:</strong>
                </p>
                <ul>
                  <li>
                    <p> непрерывный автоматический сбор данных с приборов учета и их отправка на сервер;</p>
                  </li>
                  <li>
                    <p> постоянное накопление и хранение данных за прошлые периоды;</p>
                  </li>
                  <li>
                    <p> анализ информации об энергопотреблении на предприятии, позволяющий обеспечить его оптимизацию;</p>
                  </li>
                  <li>
                    <p> выявление несанкционированных подключений к сети энергоснабжения на предприятии;</p>
                  </li>
                  <li>
                    <p> удаленное подключение и отключение от сети конечных потребителей.</p>
                  </li>
                </ul>
                <p>
                  {" "}
                  АО «Мособлэнерго» предоставляет услугу по выполнению силами своих специалистов мероприятий по проектированию систем учета электроэнергии, установке и обслуживанию комплекса АИИСКУЭ, снятию показаний с приборов учета, а также оценке
                  ...
                  <table>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Проектирование систем учёта электроэнергии</td>
                        <td style={{ textAlign: "center" }}>1 объект</td>
                        <td style={{ textAlign: "center" }}>индивидуально</td>
                      </tr>
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Установка и обслуживание комплекса АИИС КУЭ</td>
                        <td style={{ textAlign: "center" }}>1 объект</td>
                        <td style={{ textAlign: "center" }}>индивидуально</td>
                      </tr>
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>
                          ...
                          <br />
                          (проверка цепей учета, снятие <br />и передача потребителю профиля мощности, <br />
                          составление баланса электрической энергии <br />и мощности, тепловизионный контроль,
                          <br />
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>
                          Оценка режима потребления клиента <br />с целью определения <br />
                          прогнозируемого роста стоимости услуг <br />
                          по передаче электрической энергии <br />
                          для потребителей группы «прочие потребители» <br />в части оплаты максимальной
                          <br />
                          резервируемой мощности <br />
                          (на основании данных об объёмах <br />
                          потребления и имеющейся документации <br />о технологическом присоединении, <br />
                          без выезда на объект клиента)
                        </td>
                        <td style={{ textAlign: "center" }}>1 объект (24 раб. часа)</td>
                        <td style={{ textAlign: "center" }}>индивидуально</td>
                      </tr>
                    </tbody>
                  </table>
          ...
          <div className="accordion-row">
            ...
            <div className="accordion-row__drop-down">
              <div className="accordion-row__wrapper">
                ...
                <p> АО «Мособлэнерго» предоставляет широкий спектр услуг по выполнению работ, связанных с установкой/заменой приборов учёта электрической энергии, трансформаторов тока, их калибровку, поверку и обслуживание.</p>
                <p>
                  {" "}
                  <strong>Доверив выполнение работ нашим специалистам, Вы можете быть уверены, что учёт электрической энергии и обслуживание систем учета осуществляется должным образом.</strong>
                </p>
                <div className="wrap-table">
                  <table>
                    <colgroup>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          Бытовой сектор, многоэтажные дома, <nobr>1-й</nobr> электросчетчик
                        </td>
                        <td>1 шт.</td>
                        <td>от 1 450</td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          Бытовой сектор, многоэтажные дома, начиная со <nobr>2-го</nobr> электросчетчика
                        </td>
                        <td>1 шт.</td>
                        <td>65,00</td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td>Бытовой сектор, одноэтажные дома, индивидуальные домовладения</td>
                        <td>1 шт.</td>
                        <td>от 700</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>Бытовой сектор, многоэтажные дома, 1 -й электросчетчик</td>
                        <td>1 шт.</td>
                        <td>от 750</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>Замена оборудования по выявленным неисправностям</td>
                        <td>объект</td>
                        <td>индивидуально</td>
                      </tr>
                      <tr>
            ...
            <div className="accordion-row__drop-down">
              <div className="accordion-row__wrapper">
                ...
                <p>
                  ...
                  электроэнергии и возможность контролировать потребление энергоресурсов.
                </p>
                <p>
                  {" "}
                  <strong>
                    Для каждого клиента специалисты нашей компании подбирают проектные решения с учетом особенностей, технических характеристик, поставленных заказчиком задач и целей. Установленное оборудование эффективно взаимодействует с
                    программным обеспечением и техническим оснащением объектов.{" "}
                  </strong>
                </p>
                <p>
                  {" "}
                  Комплектацию шкафов наши специалисты разрабатывают согласно потребностям клиента, в некоторых имеется возможность применять типовые модели. Этот вариант актуален, когда оборудование учета не требует сложных функциональных свойств.{" "}
                </p>
                <p>
                  {" "}
                  Заказчикам, которые уже используют системы учета энергии, АО «Мособлэнерго» предлагает высококвалифицированный сервис и обслуживание АИИСКУЭ. Согласно законодательным нормам, регулярное обслуживание системы является обязательным
                  условием. Оно включает проверку функциональности установленной периодичностью, диагностику приборов учета, восстановление вышедших из строя сегментов и устройств.
                </p>
                <div className="wrap-table">
                  <table>
                    <colgroup>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Разработка проектно-сметной документации на Автоматизированную информационно-измерительную систему коммерческого учета электроэнергии (АИИС КУЭ) с количеством узлов учета до 5</td>
                        <td>1 шт.</td>
                        <td>индивидуально</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          Бытовой сектор и юридические лица, <nobr>1-й</nobr> электросчетчик в АИИС КУЭ
                        </td>
                        <td>1 шт.</td>
                        <td>от 230</td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          Бытовой сектор и юридические лица, начиная со <nobr>2-го</nobr> электросчетчика в АИИС КУЭ
                        </td>
                        <td>1 шт.</td>
                        <td>от 60</td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td>
                          Юридические лица, <nobr>1-й</nobr> электросчетчик в АИИС КУЭ
                        </td>
                        <td>1 шт.</td>
                        <td>2 000,00</td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          Юридические лица, начиная со <nobr>2-го</nobr> электросчетчика в АИИС КУЭ
                        </td>
                        <td>1 шт.</td>
                        <td>650,00</td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td>Настройка и программирование точки учета в базе клиента (с выездом)</td>
                        <td>1 шт.</td>
                        <td>3 300,00</td>
                      </tr>
                      <tr>
                        ...
                        <td>Настройка и программирование точки учета в базе клиента (без выезда)</td>
                        <td>1 шт.</td>
                        <td>1 400,00</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>Настройка и программирование удаленного дисплея к прибору учета электрической энергии</td>
                        <td>1 шт.</td>
                        <td>1 450,00</td>
                      </tr>
                      <tr>
          ...
          <div className="accordion-row">
            ...
            <div className="accordion-row__drop-down">
              <div className="accordion-row__wrapper">
                ...
                <p>
                  {" "}
                  <strong>С помощью сетей наружного освещения решаются несколько задач:</strong>
                </p>
                <ul>
                  <li>
                    <p> безопасность;</p>
                ...
                <p>
                  {" "}
                  АО «Мособлэнерго» предоставляет услуги по проектированию и оперативно-техническому обслуживанию сетей наружного освещения, систем освещения городов, промышленных предприятий, садоводческих товариществ, въездных групп частных
                  домовладений.{" "}
                </p>
                <p>
                  {" "}
                  Специалисты компании имеют большой практический опыт, и предлагают своим клиентам конкурентные цены для достижения высокого качества при экономии затрат. Используются современные и энергосберегающие технологии, которые позволяют
                  эксплуатировать сети наружного освещения в различных температурных диапазонах (от — 40°C до + 40°С), достигать лучших показателей освещенности и сокращать потребление энергии. Клиентам предоставляются лучшие решения по организации
                  уличного освещения, предусматривающие высокое качество и оптимальные сроки выполняемых работ.
                </p>
                <p>
                  {" "}
                  Профессиональное обслуживание сетей уличного освещения выполняется посредством специальной техники и бригады обученных электромонтёров. Все работники имеют допуск к высотным работам и используют испытанное измерительное оборудование
                  и средства защиты.
                </p>
                <p>
                  {" "}
                  <strong>Доверив обслуживание сетей наружного освещения нашим специалистам, Вы можете быть уверены в их исправной работе и безопасности для окружающих людей.</strong>
                </p>
                <div className="wrap-table">
                  <table>
                    <colgroup>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Монтаж и обслуживание сетей наружного освещения</td>
                        <td style={{ textAlign: "center" }}>объект</td>
                        <td style={{ textAlign: "center" }}>индивидуально</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Осмотр пунктов питания и оборудования управления наружным освещением</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Замена контроллера (без учета материалов)</td>
                        <td style={{ textAlign: "center" }}>шт.</td>
                        <td style={{ textAlign: "center" }}>7 450,00</td>
                      </tr>
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Замена светового реле</td>
                        <td style={{ textAlign: "center" }}>шт.</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Капитальный ремонт оборудования в шкафах уличного освещения напряжением 0,4 кВ на трансформаторных подстанциях</td>
                        <td style={{ textAlign: "center" }}>чел/ч</td>
                        <td style={{ textAlign: "center" }}>2 450,00</td>
                      </tr>
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>
                          Осмотр трасс ВЛ <nobr>0,22-0,4 кВ</nobr> уличного освещения на предмет целостности и рабочего состояния осветительных приборов
                        </td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Измерение сопротивления заземляющего устройства корпуса светильника уличного освещения</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Монтаж светильника уличного освещения на железобетонной или деревянной опоре ВЛ-0,4 кВ (без учета материалов)</td>
                        <td style={{ textAlign: "center" }}>шт.</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Замена ламп в светильниках уличного освещения (без учета материалов)</td>
                        <td style={{ textAlign: "center" }}>шт.</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Замена светильника уличного освещения на опоре 0,4 кВ с применением ГПМ</td>
                        <td style={{ textAlign: "center" }}>шт.</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Замена светильника уличного освещения на опоре 0,4 кВ</td>
                        <td style={{ textAlign: "center" }}>шт.</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Ремонт светильника уличного освещения на опоре 0,4 кВ</td>
                        <td style={{ textAlign: "center" }}>чел/ч</td>
                        <td style={{ textAlign: "center" }}>2 500,00</td>
                      </tr>
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Чистка светильника</td>
                        <td style={{ textAlign: "center" }}>чел/ч</td>
                        <td style={{ textAlign: "center" }}>900,00</td>
                      </tr>
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Проведение замеров светотехнических параметров светильника</td>
                        <td style={{ textAlign: "center" }}>чел/ч</td>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Монтаж опор ВЛ -&nbsp;0,4 кВ, совмещенных со светильником уличного освещения</td>
                        <td style={{ textAlign: "center" }}>шт.</td>
                        <td style={{ textAlign: "center" }}>индивидуально</td>
                      </tr>
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Монтаж провода СИП и провода питания светильников уличного освещения на опоры ВЛ-0,4 кВ</td>
                        <td style={{ textAlign: "center" }}>км.</td>
                        <td style={{ textAlign: "center" }}>индивидуально</td>
                      </tr>
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Проектирование сетей освещения</td>
                        <td style={{ textAlign: "center" }}>объект</td>
                        <td style={{ textAlign: "center" }}>индивидуально</td>
                      </tr>
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>Монтаж автоматики сетей освещения в электроустановках до 1000 В</td>
                        <td style={{ textAlign: "center" }}>объект</td>
                        <td style={{ textAlign: "center" }}>индивидуально</td>
                      </tr>
                    </tbody>
            ...
            <div className="accordion-row__drop-down">
              <div className="accordion-row__wrapper">
                ...
                <p>
                  {" "}
                  <strong>
                    Для тех, кому необходимо осуществить подключение своего дома или садового участка к сети электроснабжения, наша компания разработала специальные комплексные решения, которые значительно упростят и удешевят стоимость всех работ.
                  </strong>
                </p>
                <p>
                  {" "}
                  <strong>АО «Мособлэнерго» предоставляет комплексные услуги по выполнению нашими специалистами мероприятий для подключения к электрическим сетям жилых домов и садовых участков. Услуга включает в себя:</strong>
                </p>
                <ul>
                  <li>
                    <p> проектирование и строительство трансформаторных подстанций, кабельных и воздушных линий электропередачи (ЛЭП);</p>
                  </li>
                  <li>
                    <p> сборка и монтаж узлов учета электрической энергии на опорах для возможности присоединения электрооборудования и электроинструмента на период строительства;</p>
                  </li>
                  <li>
                    <p> технологическое присоединение энергопринимающих устройств (временных и постоянных строений) на территории земельного участка;</p>
                  </li>
                  <li>
                    <p> монтаж ответвлений от магистральной ЛЭП до энергопринимающего устройства заявителя.</p>
                  </li>
                </ul>
                <p>
                  {" "}
                  <strong>Использование услуг нашей компании будет иметь для Вас значительные преимущества:</strong>
                </p>
                <ul>
                  <li>
                    <p> отсутствие необходимости самостоятельного выполнения электромонтажных работ;</p>
                  </li>
                  <li>
                    <p> качественно выполненные работы с использованием современных материалов;</p>
                  </li>
                  <li>
                  ...
                  <li>
                    <p> экономия вашего времени, быстрое подключение к электрическим сетям.</p>
                  </li>
                </ul>
                <div className="wrap-table">
                  <table>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          - Установка щита -&nbsp;1 шт.;
                          <br />- Установка автоматического выключателя вводного -&nbsp;1шт.
                          <br />- Подведение провода СИП (в воздушном исполнении) от объекта элнектроснабжения до присоединяемого объекта (не более 10 метров).
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <br />- Установка щита учёта на «трубостойке» -&nbsp;1 шт.;
                          <br />- Установка автоматического выключателя вводного -&nbsp;1шт.;
                          <br />- Установка автоматического выключателя <nobr>3-фазного -</nobr>&nbsp;1шт.;
                          <br />- Установка автоматического выключателя <nobr>1-фазного -</nobr>&nbsp;1шт.;
                          <br />- Установка розетки <nobr>1-фазной -</nobr>&nbsp;1шт.; <br />
                          -&nbsp;Установка розетки <nobr>3-фазной -</nobr>&nbsp;1шт.
                        </td>
                        <td>Комплект «Базовый +»</td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          - Установка «трубостойки» -&nbsp;1 шт.;
                          <br />- Установка щита учёта на «трубостойке» -&nbsp;1 шт.;
                          <br />- Установка прибора учёта электрической энергии -&nbsp;1 шт.; <br />- Установка автоматических выключателей -&nbsp;2 шт.
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <br />- Установка щита учёта на «трубостойке» -&nbsp;1 шт.;
                          <br />- Установка прибора учёта электрической энергии -&nbsp;1 шт.; <br />- Установка автоматических выключателей -&nbsp;2 шт.;
                          <br />- Монтаж устройства заземления «трубостойки» -&nbsp;1 шт.;
                          <br />- Подведение провода СИП (в воздушном исполнении) от опоры до «трубостойки» -&nbsp;не более 10 метров.
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          - Установка прибора учёта электрической энергии (марки «РиМ» или «Матрица» с дистанционным дисплеем) на опоре ВЛ 0,4 кВ -&nbsp;1 шт.;
                          <br />- Подведение провода СИП (в воздушном исполнении)от опоры до присоединяемого объекта (не более 25 метров).
                        </td>
                      ...
                      <tr>
                        ...
                        <td>Монтаж ввода 1-фазного в дом от опоры (натяжка провода СИП)</td>
                        <td>1 м.</td>
                        <td>620,00</td>
                      </tr>
                      <tr>
                        ...
                        <td>Монтаж ввода 3-фазного от электросетевых объектов АО&nbsp;«Мособлэнерго» до потребителя (натяжка провода СИП)</td>
                        <td>1 м.</td>
                        <td>700,00</td>
                      </tr>
                      <tr>
                        ...
                        <td>Демонтаж ввода 1-фазного от электросетевых объектов АО&nbsp;«Мособлэнерго» до потребителя</td>
                        <td>1 м.</td>
                        <td>250,00</td>
                      </tr>
                      <tr>
                        ...
                        <td>Демонтаж ввода 3-фазного от электросетевых объектов АО&nbsp;«Мособлэнерго» до потребителя</td>
                        <td>1 м.</td>
                        <td>350,00</td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          Замена ввода <nobr>1-фазного</nobr> от электросетевых объектов АО «Мособлэнерго» до потребителя (натяжка провода СИП)
                        </td>
                        <td>1 м.</td>
                        <td>800,00</td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          Замена ввода <nobr>3-фазного</nobr> от электросетевых объектов АО «Мособлэнерго» до потребителя (натяжка провода СИП)
                        </td>
                        <td>1 м.</td>
                        <td>900,00</td>
                      </tr>
            ...
            <div className="accordion-row__drop-down">
              <div className="accordion-row__wrapper">
                <p>
                  ...
                  доб. 3327, доб. 1096; e-mail: <a href="mailto:uslugi@mosoblenergo.ru">uslugi@mosoblenergo.ru</a>
                </p>
                <p></p>
                <p></p>
                <ul>
                ...
                <p>
                  {" "}
                  <strong>
                    Если Вы владеете земельным участком, на территории которого находятся электрические сети или электрооборудование (опоры, трансформаторные подстанции, подземные линии электропередачи), и Вы хотите перенести их за границы своего
                    участка, АО «Мособлэнерго» предоставляет Вам комплексную услугу по выносу (переустройству) объектов электросетевого хозяйства, включающую в себя:
                  </strong>
                </p>
                <ul>
                  <li>
                    <p> заключение договора на комплекс мероприятий по выносу (переустройству) объектов электросетевого хозяйства;</p>
                  </li>
                  <li>
                    <p> предпроектное обследование участка, поиск технических и конструктивных решений возможного выноса (переустройства) сетей; </p>
                  </li>
                  <li>
                    <p> разработку проектной, рабочей и исполнительной документации;</p>
                  </li>
                  <li>
                    <p> согласование проектной, рабочей и исполнительной документации со всеми заинтересованными лицами, организациями и службами (землепользователями и балансодержателями коммуникаций);</p>
                  </li>
                  <li>
                    <p> выполнение строительно-монтажных работ по освобождению земельного участка;</p>
                  </li>
                  <li>
                    <p> технический надзор за сооружением электросетевых объектов;</p>
                  </li>
                  <li>
                ...
                <p> АО «Мособлэнерго» имеет значительный опыт выполнения выноса (переустройства) объектов электросетевого хозяйства.</p>
                <p> Имея в штате более 1500 единиц спецтехники и бригад квалифицированных работников, все работы проводятся в соответствии с требованиями закона и надзорных органов, качественно и в минимально возможные сроки.</p>
                <p> Результатом оказания услуги является снятие обременений с земельного участка. Это позволит Вам в полной мере использовать потенциал земельного участка, и повышает его рыночную стоимость.</p>
                <div className="wrap-table">
                  <table align="center">
                    <colgroup>
                      <col /> <col /> <col /> <col />
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: "center" }}>
                          ...
                          на пересечение <br />и параллельное следование <br />с объектами электросетевого <br />
                ...
                <p> * В случае финансирования выноса (переустройства) сетей АО «Мособлэнерго» исключительно за счет средств коммерческих организаций, физических лиц, индивидуальных предпринимателей — выдача ТУ/ТЗ не осуществляется</p>
                <p>
                  {" "}
                  Согласно ст. 5 Федерального закона от 31.07.2020 № <nobr>254-ФЗ</nobr> «Об особенностях регулирования отдельных отношений в целях модернизации и расширения магистральной инфраструктуры и о внесении изменений в отдельные
                  законодательные акты Российской Федерации» (далее — Закон <nobr>254-ФЗ)</nobr> в случае, если в связи с планируемым строительством или реконструкцией линейных объектов инфраструктуры необходима реконструкция линейного объекта, в
                  течение двадцати дней со дня поступления обращения в письменной форме без взимания платы выдаются технические требования и условия, подлежащие обязательному исполнению при подготовке проектной документации.
                </p>
                <p> ** Стоимость услуги утверждается ежегодно Комитетом по ценам и тарифам Московской области.</p>
                <p>
                  {" "}
                  Согласно статьи 52.2 ГрК РФ указанная стоимость услуги применима для линейных объектов транспортной инфраструктуры федерального значения, транспортной инфраструктуры регионального значения, транспортной инфраструктуры местного
                  значения при наличии утвержденного в соответствии с частью 12.12 статьи 45 ГрК РФ проекта планировки территории; для многоквартирных жилых домов, жилых домов блокированной застройки и необходимых для их функционирования объектов
                  коммунальной инфраструктуры, объектов транспортной инфраструктуры, а также объектов социальной инфраструктуры, если предусмотрено изменение местоположения существующих линейных объектов.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="accordion-row__drop-down">
              <div className="accordion-row__wrapper">
                ...
                <p>
                  ...
                  сооружением электросетевых объектов. Наши инженеры строительного контроля уделят самое пристальное внимание соблюдению всех норм и правил.{" "}
                </p>
                <p>
                  {" "}
                  Используя большой опыт, знания и оборудование, специалисты нашей компании помогут Вам исключить факты нарушения технологии производства работ, результатом которых может стать снижение эксплуатационных характеристик объектов,
                  возникновение гарантийных случаев после завершения строительства.
                </p>
                <p>
                  {" "}
                  <strong>В рамках технического надзора за проведением строительно-монтажных работ с выездом на объект осуществляется контроль:</strong>
                </p>
                <ul>
                  <li>
                    <p> за соблюдением технологии производства и качества строительно-монтажных работ в соответствии с положениями действующих СП, СНиП, иных нормативных документов;</p>
                  </li>
                  <li>
                    <p> за соблюдением календарного плана строительно-монтажных работ;</p>
                  </li>
                  <li>
                    <p> за соответствием используемых материалов и оборудования спецификации, указанной в проектной документации, организацией их складирования и хранения, наличием необходимых документов на используемые материалы;</p>
                  </li>
                  <li>
                    <p> за подготовкой и предоставлением полного комплекта исполнительной документации, включающей в себя все исполнительные схемы, акты скрытых работ, паспорта и сертификаты на оборудование.</p>
                  </li>
                </ul>
                <p>
                  <b>Услуги по техническому надзору за сооружением электросетевых объектов (Норматив расхода на осуществление строительного контроля)*</b>
                </p>
                <div className="wrap-table">
                  <table>
                    <colgroup>
                ...
                <p>* Определенный по таблице процент норматива расхода применяется к стоимости сметной документации, составленной в текущем уровне цен, принятом в договоре.</p>
              </div>
            </div>
          </div>
          <p></p>
